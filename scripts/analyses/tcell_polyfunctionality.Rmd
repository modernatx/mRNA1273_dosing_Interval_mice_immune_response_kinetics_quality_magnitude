...
```{r echo = FALSE}
cowplot::save_plot(
  filename = "figures_tables/polyfunctional_tcell/threshold/betanormalmixture.png",
  plot = pgrid_out,
  ncol = 4,
  nrow = 2
)
...
```{r echo = FALSE}
ggsave(filename = "figures_tables/polyfunctional_tcell/model/interval_CD4_one.png", plot = contrast_plots1$f4[[1]], width = 11.8, height = 3.85)
ggsave(filename = "figures_tables/polyfunctional_tcell/model/interval_CD4_two.png", plot = contrast_plots1$f4[[2]], width = 11.8, height = 3.85)
ggsave(filename = "figures_tables/polyfunctional_tcell/model/interval_CD4_three.png", plot = contrast_plots1$f4[[3]], width = 11.8, height = 3.85)

ggsave(filename = "figures_tables/polyfunctional_tcell/model/interval_CD8_one.png", plot = contrast_plots1$f8[[1]], width = 11.8, height = 3.85)
ggsave(filename = "figures_tables/polyfunctional_tcell/model/interval_CD8_two.png", plot = contrast_plots1$f8[[2]], width = 11.8, height = 3.85)
ggsave(filename = "figures_tables/polyfunctional_tcell/model/interval_CD8_three.png", plot = contrast_plots1$f8[[3]], width = 11.8, height = 3.85)
```
